                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(msgType.equals("1")){
                                Log.d("Registrierungsprozess","Erfolgreich");
                                final AlertDialog.Builder adb = new AlertDialog.Builder(RegisterActivity.this);
                                adb.setTitle("Benutzer hinzugefügt");
                                adb.setMessage("Benutzer erfolgreich angelegt");
                                ...
                                adb.show();
                            }else if(information.equals("Benutzer existiert bereits")){
                                showProgress(false);
                                mEmailView.setError("Ein Benutzer mit dem Benutzernamen " + mEmailView.getText().toString() +" existiert bereits");
                            }
